...
// Keep all user-facing copy together so each language stays in sync.
const translations = {
  en: {
    title: "Top Fresh Market | Asian Grocery in Halifax",
    description:
      "Top Fresh Market - fresh Asian groceries, produce, seafood, snacks, and pantry favourites in Halifax.",
    navLabel: "Main navigation",
    nav: ["Departments", "Visit us", "Call store"],
    eyebrow: "Your neighbourhood Asian grocer",
    heroTitle: "Fresh finds.<br><span>Flavours from home.</span>",
    heroText:
      "Discover crisp produce, live seafood, pantry staples, and the snacks you love—all under one roof.",
    heroActions: ["Plan your visit", "Explore the store"],
    locationNote: "Visit us at 1 Flamingo Drive, Halifax",
    carouselLabel: "Top Fresh Market highlights",
    ...
    slides: [
      ["Welcome to Top Fresh", "Your local market for everyday favourites"],
      ["Fresh produce, every day", "Familiar favourites and exciting finds"],
      ["A pantry full of possibilities", "Snacks, noodles, sauces, and more"],
      ["Seafood worth sharing", "Fresh choices for the family table"],
      ["Taste something new", "Seasonal fruit from around the world"],
      ["Great value, close to home", "Fresh specials for your weekly shop"],
    ],
    imageAlts: [
      "The front entrance of Top Fresh Market",
      "A colourful selection of fresh fruit",
      "Shelves stocked with Asian snacks and pantry foods",
      "Fresh cooked crabs on display",
      "Fresh purple mangosteens",
      "Fresh tomatoes on sale",
    ],
    shop: "Shop the market",
    departmentsTitle: "Good food starts here",
    departmentsIntro:
      "Quality ingredients for quick weeknight meals, family celebrations, and everything between.",
    departments: [
      [
        "Fresh produce",
        "Seasonal greens, tropical fruit, and everyday essentials.",
      ],
      [
        "Seafood & meat",
        "Fresh selections prepared for your favourite recipes.",
      ],
      [
        "Pantry staples",
        "Rice, noodles, sauces, spices, and hard-to-find ingredients.",
      ],
      [
        "Snacks & drinks",
        "Sweet, savoury, refreshing, and always fun to discover.",
      ],
    ],
    hello: "Come say hello",
    visitTitle: "Your next fresh find<br>is just around the corner.",
    location: "Location",
    address: "1 Flamingo Drive<br>Halifax, Nova Scotia",
    questions: "Questions?",
    contact: "Contact us",
    footer: "Fresh food. Friendly faces. Local heart.",
    switchLabel: "Switch to Mandarin Chinese",
    switchText: "中文",
    status: {
      closed: "Closed",
  ...
  zh: {
    title: "Top Fresh Market | 哈利法克斯亚洲超市",
    description:
      "Top Fresh Market——哈利法克斯的新鲜亚洲食品超市，供应蔬果、海鲜、零食和厨房必备品。",
    navLabel: "主导航",
    nav: ["商品分类", "到店购物", "致电门店"],
    eyebrow: "您身边的亚洲超市",
    heroTitle: "新鲜好物，<br><span>家乡味道。</span>",
    heroText: "新鲜蔬果、鲜活海产、厨房必备和心爱零食，一站购齐。",
    heroActions: ["计划到店", "探索门店"],
    locationNote: "地址：哈利法克斯 Flamingo Drive 1号",
    carouselLabel: "Top Fresh Market 精选展示",
    previous: "上一张图片",
    next: "下一张图片",
    pause: "暂停轮播",
    play: "播放轮播",
    ...
    showImage: "显示图片",
    slides: [
      ["欢迎来到 Top Fresh", "您身边的超市，满足日常所需"],
      ["每日新鲜蔬果", "熟悉的美味与新奇的发现"],
      ["琳琅满目的厨房食材", "零食、面条、酱料，应有尽有"],
      ["值得分享的鲜美海产", "为家庭餐桌精选的新鲜食材"],
      ["尝试一种新味道", "来自世界各地的时令水果"],
      ["实惠价格，就在身边", "每周新鲜特价精选"],
    ],
    imageAlts: [
    ...
    shop: "选购全店好物",
    departmentsTitle: "美好滋味，从这里开始",
    departmentsIntro:
      "无论是工作日晚餐、家庭聚会，还是日常饮食，都能找到优质食材。",
    departments: [
      ["新鲜蔬果", "时令绿叶菜、热带水果和每日必备。"],
      ["海鲜与肉类", "为您喜爱的食谱准备新鲜食材。"],
      ["厨房必备", "米、面、酱料、香料及特色食材。"],
      ["零食与饮品", "甜的、咸的、清爽的，每次都有新发现。"],
    ],
    hello: "欢迎光临",
    visitTitle: "下一份新鲜好物，<br>就在街角等您。",
    location: "地址",
    address: "Flamingo Drive 1号<br>哈利法克斯，新斯科舍省",
    questions: "有疑问？",
    contact: "联系我们",
    footer: "新鲜食物，亲切笑脸，本地情怀。",
    switchLabel: "切换为英文",
    switchText: "English",
    status: {
      closed: "已打烊",
...
function applyLanguage(language, remember = true) {
  ...
  document.querySelectorAll(".site-header nav a").forEach((link, index) => {
  ...
  document.querySelectorAll(".hero-actions a").forEach((link, index) => {
    link.textContent = copy.heroActions[index];
  });
  ...
  dots.forEach((dot, index) =>
    dot.setAttribute("aria-label", `${copy.showImage} ${index + 1}`),
  );
  ...
  document
    .querySelectorAll(".department-grid article")
    .forEach((card, index) => {
  ...
  document.querySelector(".visit-details p:first-child strong").innerHTML =
    copy.address;
...
// Build and control the featured-products carousel.
...
document
  ...
  .addEventListener("click", () => showSlide(currentSlide - 1, true));
document
  .querySelector(".next")
  .addEventListener("click", () => showSlide(currentSlide + 1, true));
...
// Store hours are evaluated in Halifax time, regardless of the visitor's zone.
...
// Language choices persist across visits; first-time visitors see the dialog.
